...
This project is indexed by GitNexus as **wt288** (2803 symbols, 7257 relationships, 227 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/wt288/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/wt288/context` | Codebase overview, check index freshness |
| `gitnexus://repo/wt288/clusters` | All functional areas |
| `gitnexus://repo/wt288/processes` | All execution flows |
| `gitnexus://repo/wt288/process/{name}` | Step-by-step execution trace |
