...
This project is indexed by GitNexus as **wt259** (2572 symbols, 8126 relationships, 209 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/wt259/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/wt259/context` | Codebase overview, check index freshness |
| `gitnexus://repo/wt259/clusters` | All functional areas |
| `gitnexus://repo/wt259/processes` | All execution flows |
| `gitnexus://repo/wt259/process/{name}` | Step-by-step execution trace |
